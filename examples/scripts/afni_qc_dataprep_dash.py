...
def create_heatmap(data, variable_labels, title="", n=2):
    ...
    for i in range(n):
        ...
        fig.update_xaxes(
            tickmode="array",
            tickvals=x_coords,
            ticktext=plot_data_num.columns,  # show IDs
            tickangle=45,
            showline=False,
            showgrid=False,
            zeroline=False,
            ...
            html.Div([
                ...
                html.Div([
                    ...
                    dcc.RangeSlider(
                        ...
                        min=0,
                        max=df_final['cens_displace'].max() + 20,
                        value=[0, 6],
                        step=0.01,
...
def update_all_data(*args):
    ...
    # Prepare qualitative heatmap data
    qual_data = []
    for _, row in filtered_df.iterrows():
